...
### lon=2 x lat=2 x depth=model, time monthly
    ...
    o_dir <-paste(global_path,"Res_model/radtrans_marshall_oasim_aphyvar_initial_carbon_1slope_2group_fix", sep="")
    archivo<-"/grid.nc"
...
########              
            ...
            save(tabla_total,file=paste(OS,"Datos/Dat_SGlobal_depth/Valente-BO/Valente-etal_2019/grids/","tabla_total_Aph.Rdata",sep=""))
